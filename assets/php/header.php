...
<!--            <div class="collapse navbar-collapse" id="navbarSupportedContent">-->
                <ul class="navbar-nav mr-auto">
                 ...
                 <span id="welcomeMessage" class="navbar-text text-light mr-auto">
                    <?php
                    if (!empty($_SESSION['user'])) {
                        echo 'Bienvenue '.$_SESSION['user']->get_UserFullName();
                    }
                    ?>
                </span>
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <button class="btn btn-outline-primary my-2 my-sm-0 mx-2"
                            type="button" onclick="location.href='/OnlineAdvisor/login'"
                        <?php
                        ...
                        ?>
                    >Login</button>
                    <a class="btn btn-outline-danger my-sm-0 mx-2"
                            href="/OnlineAdvisor/logout"
                            id="logOut"
                        <?php
                        if (isset($_SESSION['user'])) {
                            echo "style='display:block'";
